...
import { Box, Typography, Dialog, DialogTitle, DialogContent, DialogActions, Button, Card, CardMedia, CardContent, CardActions } from '@mui/material'; // Updated import statements
